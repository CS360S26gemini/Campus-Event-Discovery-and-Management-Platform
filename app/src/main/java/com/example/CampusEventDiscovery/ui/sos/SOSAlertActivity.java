...
public class SOSAlertActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnDismiss.setOnClickListener(v -> new AlertDialog.Builder(this)
                .setTitle(R.string.dismiss_sos_alert_title)
                .setMessage(R.string.dismiss_sos_alert_message)
                .setPositiveButton(R.string.dismiss, (dialog, which) -> finish())
