...
@Config(sdk = {30})
@Ignore("Backend repository test is stale: PaymentRepository no longer exposes an injectable Firestore constructor. Disabled while running UI-only test coverage.")
